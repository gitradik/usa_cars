<div class="partners">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="open-form-logo-slider"  data-aos-duration="1000">
                    <div>
                        <div class="photo-gallery-slider-item logo-item">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/partners/PrivatBank-corporate-logo-latina.png">
                        </div>
                    </div>
                    <div>
                        <div class="photo-gallery-slider-item logo-item">
